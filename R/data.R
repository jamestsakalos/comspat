...
##' `grid_patchy` and features interspecific and intraspecific spatial
##' dependence due to simulated abiotic and biotic interactions. The
##' `grid_random` and `grid_patchy_n_isc` data sets were produced by CSR and RS
##' randomizations of the original simulation `grid_patchy`. The
##' `grid_patchy_n_isc` data set only features intraspecific spatial dependence;
##' interspecific relationships were removed by randomizations. The
##' `grid_random` data set only features random distributions; both
##' intra- and interspecific relationships were removed by randomizations.
##'
##' @docType data
...
##' @details The `X` and `Y` coordinates refer to the sampling unit of the
##' species in the sampling universe.
##' @keywords datasets
##' @encoding UTF-8
##' @examples
...
##' `grid_patchy` and features interspecific and intraspecific spatial
##' dependence due to simulated abiotic and biotic interactions. The
##' `grid_random` and `grid_patchy_n_isc` data sets were produced by CSR and
##' RS randomizations of the original simulation `grid_patchy`. The
##' `grid_patchy_n_isc` data set only features intraspecific spatial dependence;
##' interspecific relationships were removed by randomizations. The
##' `grid_random` data set only features random distributions; both intra- and
##' interspecific relationships were removed by randomizations.
##'
##' @docType data
##' @format A data frame with 1551 species observations on the following three
##' variables.
